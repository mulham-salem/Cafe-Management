...
function Login() {
          ...
          >
            <div className={styles.textContainer}>
              ...
              <p className={styles.message}>
                Hope to see you again at Coffee House!
              </p>
            </div>
          </div>
        ));
  ...
  return (
    <div
      className={`${styles.container} ${bgLoaded ? styles.bgFadeIn : ""}`}
      style={bgLoaded ? { backgroundImage: `url(${bg})` } : {}}
    >
      <ToastContainer position="top-center" autoClose={3000} />
      <Toaster />
      <div
        className={`${styles.leftText} ${isTextVisible ? styles.fadeIn : ""}`}
      >
        <h1>
          {" "}
          Start your day with flavor and warmth at <span>
            {" "}
            Cafe Delights{" "}
          </span>{" "}
        </h1>
